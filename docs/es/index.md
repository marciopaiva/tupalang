...
Organizar la documentación por audiencia y mejorar la navegación.

## Política de idioma

El inglés es el idioma canónico de la documentación. La alternativa PT-BR vive en [docs/pt-br](../pt-br/index.md).

## Fuente única

Las páginas del wiki se replican automáticamente desde `docs/`. Evita editar el wiki manualmente.
...
- [Errores comunes](reference/common_errors.md)
- [Guía de ejemplos](guides/examples_guide.md)
- [Glosario de sintaxis](reference/syntax_glossary.md)
...
- [FAQ de contribuciones](guides/contributing_faq.md)
- [Guía de issues](governance/issues_guide.md)
- [Política de seguridad](governance/security.md)

## Para colaboradores

- [Cómo contribuir](../../CONTRIBUTING.md)
- [Código de conducta](../../CODE_OF_CONDUCT.md)
- [Entorno de desarrollo](guides/dev_env.md)

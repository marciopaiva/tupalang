...
<p align="center">
  <a href="https://github.com/marciopaiva/tupalang/actions"><img alt="CI" src="https://img.shields.io/github/actions/workflow/status/marciopaiva/tupalang/ci.yml?branch=main&label=CI" /></a>
    <a href="docs/en/releases/changelog.md"><img alt="Version" src="https://img.shields.io/badge/version-0.11.0-blue.svg" /></a>
...
Tupã is distributed as a set of Rust crates. All crates are currently **0.11.x (Alpha)**.

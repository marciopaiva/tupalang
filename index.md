...
[![Build Status](https://img.shields.io/github/actions/workflow/status/tupalang/tupa/ci.yml?branch=main&logo=github)](https://github.com/tupalang/tupa/actions)
...
git clone https://github.com/tupalang/tupa
cd tupa
...
| Documento | Descrição |
|-----------|-----------|
| [SPEC.md](docs/SPEC.md) | Especificação técnica completa (gramática EBNF) |
| [ROADMAP.md](docs/ROADMAP.md) | Timeline detalhado com milestones |
| [CONTRIBUTING.md](CONTRIBUTING.md) | Guia para novos contribuidores |
| [EXAMPLES.md](examples/README.md) | Casos de uso reais (IA, microserviços, sistemas críticos) |
...
- [GitHub Discussions](https://github.com/tupalang/tupa/discussions) — RFCs e debates técnicos
